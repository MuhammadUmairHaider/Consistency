...
from utilities import compute_accuracy, compute_masks, mask_distillbert, get_model_distilbert, record_activations, mask_range_distilbert, compute_avg_std
...
for j in range(0,6):
    ...
    print('Max Mask AVG spread: ', compute_avg_std(fc_vals, (~mask_max.bool()).float()))
    
    
    #computs std of the activation in max mask vs none max mask
