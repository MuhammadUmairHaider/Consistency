...
class CustomDataset(Dataset):
    def __init__(self, dataset, text_tag, tokenizer, max_length=400):
...
#    print(len(i[text_tag]))
custom_dataset = CustomDataset(dataset_all, text_tag, tokenizer)
...
for j in range(0,4):
   ...
   mask_max, mask_std, mask_intersection, mask_max_low_std, mask_max_high_std, mask_std_high_max = compute_masks(fc_vals,0.15)
