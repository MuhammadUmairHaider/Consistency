...
dataset_list = []
tokenizer = AutoTokenizer.from_pretrained("fabriceyhc/bert-base-uncased-dbpedia_14")
...
for j in range(0,14):
    ...
    mask_max, mask_std, mask_intersection, mask_max_low_std, mask_max_high_std, mask_std_high_max,mask_max_random_off, mask_random = compute_masks(fc_vals,0.5)
